...
def Stage4(config):
    ...
    symbolic_list=np.load('testdata_symboliclist1.npy')
    ...
    np.save("AllHardcoded_directionalmatrix1.npy", values)
    np.save("New_symbolic_list1.npy", test_images)
    np.save("Selected_Hardcoded_directionalmatrix1.npy", final)
