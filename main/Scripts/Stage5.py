...
def Stage5(config):
    ...
    noofimages=config['sampleimages']
    ...
    north_table.to_csv('north_table'+load_path+'.csv', index=False) #Remove 2 for orignal
    south_table.to_csv('south_table'+load_path+'.csv', index=False) 
    east_table.to_csv('east_table'+load_path+'.csv', index=False) 
    west_table.to_csv('west_table'+load_path+'.csv', index=False) 
