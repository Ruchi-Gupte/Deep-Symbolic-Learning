...
def Stage2(config,stage2_load_condition): 
    ...
    patchlist = np.load('patchlist1.npy')
    ...
    np.save('cluster_density1.npy', clusterdata)
    np.save('patch_with_clusters1.npy', clustack)
    np.save('distance_info_for_clusters1.npy', dist)
