...
def Stage3(config,stage3_load_condition): 
    ...
    test_data=np.load('Array_of_test_images1.npy',allow_pickle = True )
    ...
    if stage3_load_condition==1:
        ...
        test_symboliclist=np.load('testdata_symboliclist1.npy')
    ...
    np.save('testdata_symboliclist1.npy', test_symboliclist)
